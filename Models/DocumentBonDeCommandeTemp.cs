...
public partial class DocumentBonDeCommandeTemp
{
    public string? DocType { get; set; }

    public string? DocAnnee { get; set; }

    public double? DocRef { get; set; }
    ...
    public DateTime? F14 { get; set; }

    public double? DocRepresentant { get; set; }
    ...
    public double? DocTotalRemise { get; set; }

    public double? DocTotalTva { get; set; }
    ...
    public double? DocMontant { get; set; }
    ...
    public double? DocRefExt { get; set; }
    ...
    public DateTime? F79 { get; set; }

    public DateTime? F80 { get; set; }
